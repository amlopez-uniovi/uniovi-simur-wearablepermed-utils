#!/usr/bin/env python3
"""
CLI wrapper for feature_extraction extract_features_from_stack functionality.
"""
...
import sys
import numpy as np
from .feature_extraction import extract_features_from_stack


def main():
    """Main CLI function for stack to features extraction."""
